...
:uri-build-status: https://travis-ci.com/sc-sq-c-family-examples/linux-autotools-travis-sc
:img-build-status: https://travis-ci.com/sc-sq-c-family-examples/linux-autotools-travis-sc.svg?branch=main
